    ...
    return (
        <>
            ...
            <div id='graphForReviews'>
                <div id="user_reviews_summary_bar">
                    <div id="summary_section">
                        <div id="title">Overall Reviews:</div>
                        <span id="game_review_summary" className={reviewSumm} data-tooltip-html={tooltipText}>{reviewSumm}</span>
                        <span id='reviewNum'>{reviewNumText}</span>
                ...
                <div id='review_histogram_rollup_container' className="review_histogram">
                    <div id="review_histogram_rollup">
                        <AllReviewsChart data={data} />
                        <div className='flot-text'>
                        </div>
                        <div className="flot-y-axis flot-y1-axis yAxis y1Axis"></div>
                        <canvas className='flot-overlay' width='585' height='250'></canvas>
                    </div>
                </div>
                <div id="review_recent_container">
                    <div id='recent_summary_bar'>
                        <div className="summary_section">
                            ...
                            <span id='recentReviewNum'>{reviewNumText}</span>
                            <a className='tooltip' data-tooltip-text='This summary uses only reviews writtem by customers that purchase the game directly from Steam.'>
                                <img src="https://store.akamai.steamstatic.com/public/shared/images/ico/icon_questionmark.png"></img>
                            </a>
                        </div>
                    </div>
                    <div id='recent_review_histogram'>
                        <canvas className="flot-overlay" width="315" height="250"></canvas>
                    </div>
                </div>
