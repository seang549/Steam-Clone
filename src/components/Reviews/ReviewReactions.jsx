...
const ReviewReactions = () => {
  const list = [
    {
      Yes: "https://store.akamai.steamstatic.com/public/shared/images/buttons/icons_16.png?v=5",
    },
    {
      No: "https://store.akamai.steamstatic.com/public/shared/images/buttons/icons_16.png?v=5",
    },
    {
      Funny:
    ...
    {
      Award:
        "https://store.akamai.steamstatic.com/public/shared/images//award_icon.svg",
    },
  ];
  ...
  return (
    <div className='review-reaction-holder'>
      {list.map((icon) => {
        return <ReviewReaction icon={icon} />;
      })}
    </div>
  );
};
